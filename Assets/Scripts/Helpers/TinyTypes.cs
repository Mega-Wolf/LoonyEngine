...
public struct VelocityyMgSq {
    private float floatValue;

    public float Float { get { return floatValue; } }


    public VelocityyMgSq(float floatValue) {
        this.floatValue = floatValue;
    }

    public static VelocityyMgSq operator +(VelocityyMgSq value1, VelocityyMgSq value2) {
        return new VelocityyMgSq(value1.floatValue + value2.floatValue);
    }
    ...
    public static float operator /(VelocityyMgSq value1, VelocityyMgSq value2) {
        return value1.floatValue / value2.floatValue;
    }

    public static VelocityyMgSq operator *(VelocityyMgSq value, float scale) {
        return new VelocityyMgSq(value.floatValue * scale);
    }

    public static VelocityyMgSq operator *(float scale, VelocityyMgSq value) {
        return new VelocityyMgSq(value.floatValue * scale);
    }
    ...
    public static bool operator <(VelocityyMgSq value1, VelocityyMgSq value2) {
        return value1.floatValue < value2.floatValue;
    }
...
public struct Velocity {
    ...
    public VelocityyMgSq sqrMagnitude { get { return new VelocityyMgSq(Vector2Value.sqrMagnitude); } }
